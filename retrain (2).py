...
try:
    ...
    with open(log_filename, 'w') as f:
        f.write("Test")
    handlers.insert(0, logging.FileHandler(log_filename))
except (PermissionError, IOError):
    # If logs directory not writable, just use stdout
    print(f"[WARNING] Cannot write to {log_dir} directory. Using stdout only.")
    pass
